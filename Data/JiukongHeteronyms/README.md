...
The pinned CNS11643 plane classifies a whole character but has no concept of
"this character's reading."
...
character-level plane tier can tie the rare reading with every other everyday
...
reading of the same character keeps using the CNS character-level tier.
